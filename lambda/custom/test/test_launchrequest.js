...
const event = require('./launch_request.json')
const lambda = require('../index');

let skill_response;

describe('Hello World : LaunchRequest', function () {
    ...
    it('it responses with output speech ', () => {
        ...
        r.outputSpeech.ssml.should.contains('Bienvenue sur Alexa, vous pouvez dire bonjour.');
